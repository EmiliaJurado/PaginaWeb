  ...
  <header class="container-fluid">
    <div class="row">
      <div class="col-12 align-align-self-center text-center text-uppercase">
        ...
        <img src="{{asset('images/img17.jpg')}}" class="mx-auto d-block" width="1100px" height="336" alt="">
      </div>
    </div>
  </header>
    ...
    <main class="seccion-contenedor">
      <div class="contenedor-anuncios">
        <div class="container">
          <div class="card-group">
            <div class="card">
              ...
              <div class="card-body bg-light">
                <h5>
                  <p class="text-center font-weight-bold">Library</p>
                </h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/7.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">FDios23 </p>
                </h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/8.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">12se </p>
                </h5>
          ...
          <div class="card-group">
            <div class="card bg-light">
              <img src="{{asset('images/9.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/10.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/11.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">Cstro2</p>
                </h5>
