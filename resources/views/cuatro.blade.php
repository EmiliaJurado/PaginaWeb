    ...
    <header class="container-fluid">
      <div class="row">
        <div class="col-12 align-align-self-center text-center text-uppercase">
          ...
          <img src="{{asset('images/img14.jpg')}}" class="mx-auto d-block" width="1100px" height="336" alt="">
        </div>
      </div>
    </header>
      ...
      <main class="seccion-contenedor">
        <div class="contenedor-anuncios">
          <div class="container">
            <div class="card-group">
              <div class="card">
                <img src="{{asset('images/a.webp')}}" width="368px" height="280" alt="">
                <div class="card-body bg-light">
                  <h5>
                    <p class="text-center font-weight-bold">FF4</p>
                  </h5>
              ...
              <div class="card bg-light">
                <img src="{{asset('images/b.png')}}" width="368px" height="280" alt="">
                <div class="card-body">
                  <h5>
                    <p class="text-center font-weight-bold">FF3 </p>
                  </h5>
              ...
              <div class="card bg-light">
                <img src="{{asset('images/c.jpg')}}" width="368px" height="280" alt="">
                <div class="card-body">
                  <h5>
                    <p class="text-center font-weight-bold">Ultra 45</p>
                  </h5>
            ...
            <div class="card-group">
              <div class="card bg-light">
                <img src="{{asset('images/d.jpg')}}" width="368px" height="280" alt="">
                <div class="card-body">
                  <h5>
                    <p class="text-center font-weight-bold">Desk
                  </h5>
              ...
              <div class="card bg-light">
                ...
                <div class="card-body">
                  <h5>
                    <p class="text-center  font-weight-bold">Deks3</p>
                  </h5>
              ...
              <div class="card bg-light">
                <img src="{{asset('images/f.jpg')}}" width="368px" height="280" alt="">
                <div class="card-body">
                  <h5>
                    <p class="text-center font-weight-bold">Caf</p>
                  </h5>
