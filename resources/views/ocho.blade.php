  ...
  <header class="container-fluid">
    <div class="row">
      <div class="col-12 align-align-self-center text-center text-uppercase">
        ...
        <img src="{{asset('images/img18.webp')}}" class="mx-auto d-block" width="1100px" height="336" alt="">
      </div>
    </div>
  </header>
    ...
    <main class="seccion-contenedor">
      <div class="contenedor-anuncios">
        <div class="container">
          <div class="card-group">
            <div class="card">
              <img src="{{asset('images/12.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body bg-light">
                <h5>
                  <p class="text-center font-weight-bold">Ultra23</p>
                </h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/13.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">Ultra45</p>
                </h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/14.webp')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">Jisoer</p>
                </h5>
          ...
          <div class="card-group">
            <div class="card bg-light">
              <img src="{{asset('images/15.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">Batar
                </h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/16.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center  font-weight-bold">Extrac</p>
                </h5>
            ...
            <div class="card bg-light">
              <img src="{{asset('images/17.jpg')}}" width="368px" height="280" alt="">
              <div class="card-body">
                <h5>
                  <p class="text-center font-weight-bold">Cafete</p>
                </h5>
